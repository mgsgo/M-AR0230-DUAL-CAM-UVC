...
const uint8_t CyFxUSBSSConfigDscr[] =
    {
       ...
       /* Class-specific Video Streaming Input Header Descriptor */
...
#elif RESO_2560x720
        0x20,                           /* X dimension of the picture aspect ratio; Non-interlaced */
        0x09,                           /* Y dimension of the pictuer aspect ratio: Non-interlaced */
        ...
        0xD0, 0x02,                     /* Height in pixel */
        								//720 = 0x02D0
        0x00,0xA0,0x2E,0x63,            /* Min bit rate bits/s. */
        								//2560*720*16*30*1.880787037038 = 1664000000 = 0x632EA000
        0x00,0xA0,0x2E,0x63,            /* Max bit rate bits/s. */
        								//2560*720*16*30*1.880787037038 = 1664000000 = 0x632EA000
        0x00,0x48,0x3F,0x00,            /* Maximum video or still frame size in bytes(Deprecated)*/
        								//2560*720*2*1.125 = 4147200 = 0x003F4800
        0x15,0x16,0x05,0x00,            /* 30fps */
        0x01,
        0x15,0x16,0x05,0x00,
        								//1000000000ns/30fps/100ns unit
