...
const uint8_t CyFxUSBSSConfigDscr[] =
    {
       ...
       /* Class-specific Video Streaming Input Header Descriptor */
        ...
        0x09,                           /* Y dimension of the pictuer aspect ratio: Non-interlaced */
										//width-to-height ratio. 1280:720 = 16:9 = 0x10:0x09
#elif RESO_1920x1080
        0x10,                           /* X dimension of the picture aspect ratio; Non-interlaced */
        0x09,                           /* Y dimension of the pictuer aspect ratio: Non-interlaced */
										//width-to-height ratio. 2560:720 = 32:9 = 0x20:0x09
#endif
        0x00,                           /* Interlace Flags: Progressive scanning, no interlace */
        0x00,                           /* duplication of the video stream restriction: 0 - no restriction */
        ...
        0x00,0x50,0x97,0x31,            /* Min bit rate bits/s. */
        								//1280*720*16*30*1.880787037038 = 832000000 = 0x31975000
        0x00,0x50,0x97,0x31,            /* Max bit rate bits/s. */
        								//1280*720*16*30*1.880787037038 =  832000000 = 0x31975000
        0x00,0xA4,0x1F,0x00,            /* Maximum video or still frame size in bytes(Deprecated)*/
        								//1280*720*2*1.125 = 2073600 = 0x001FA400
        0x15,0x16,0x05,0x00,            /* 30fps */
        0x01,
        0x15,0x16,0x05,0x00,
        								//1000000000ns/30fps/100ns unit
        								//1000000000/30/100 = 333333 = 0x00051615
#elif RESO_1920x1080
        0x80, 0x07,	                    /* Width in pixel */
        								//1920 = 0x0780
        0x38, 0x04,                     /* Height in pixel */
        								//1080 = 0x0438
        0x00,0x74,0x94,0x6F,            /* Min bit rate bits/s. */
        								//1920*1080*16*30*1.880787037038 = 1872000000 = 0x6F947400
        0x00,0x74,0x94,0x6F,            /* Max bit rate bits/s. */
        								//1920*1080*16*30*1.880787037038 = 1872000000 = 0x6F947400
        0x00,0x31,0x47,0x00,            /* Maximum video or still frame size in bytes(Deprecated)*/
        								//1920*1080*2*1.125 = 4665600 = 0x00473100
		0x15,0x16,0x05,0x00,            /* 30fps */
		0x01,
		0x15,0x16,0x05,0x00,			//1000000000ns/30fps/100ns unit
										//1000000000/30/100 = 333333 = 0x00051615
#endif
