...
//#define RESO_1280x720	1
#define RESO_1920x1080	1
#define RESO_1920x1080	1
...
#if RESO_1280x720
	#define CY_FX_EP_BULK_VIDEO_PKTS_COUNT  (0x10)//(32)//          /* 16 packets (burst of 16) per DMA buffer. */
#elif RESO_1920x1080
	#define CY_FX_EP_BULK_VIDEO_PKTS_COUNT  (0x10)//(32)//          /* 16 packets (burst of 16) per DMA buffer. */
#endif
...
#if RESO_1280x720
	#define CY_FX_UVC_STREAM_BUF_COUNT      (4)//(3)//
#elif RESO_1920x1080
	#define CY_FX_UVC_STREAM_BUF_COUNT      (4)//(3)//
#endif
